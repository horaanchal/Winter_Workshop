...
d1 = mean(mydata$mention_count)
e1 = mean(mydata$likes_count)
f1 = mean(mydata$retweet_count)
...
d2 = median(mydata$mention_count)
e2 = median(mydata$likes_count)
f2 = median(mydata$retweet_count)
...
d3 <- getmode(mydata$mention_count)
e3 <- getmode(mydata$likes_count)
f3 <- getmode(mydata$retweet_count)
